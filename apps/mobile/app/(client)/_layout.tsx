...
export default function ClientLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="loans" options={{ title: 'My Loans', tabBarIcon: ({ focused }) => <TabIcon icon="💰" focused={focused} /> }} />
      <Tabs.Screen name="chits" options={{ title: 'My Chits', tabBarIcon: ({ focused }) => <TabIcon icon="🎯" focused={focused} /> }} />
      <Tabs.Screen name="score" options={{ title: 'Score', tabBarIcon: ({ focused }) => <TabIcon icon="⭐" focused={focused} /> }} />
